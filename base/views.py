...
def home(request):
    ...
    room_messages = Message.objects.filter(Q(room__topic__name__icontains=searchParam))
...
def topicsPage(request):
    ...
    topics = Topic.objects.filter(name__icontains=searchParam)
    rooms = Room.objects.filter(Q(topic__name__icontains=searchParam))
